...
in
{
  ...
  # User-level notification daemon + swaync-client
  services.swaync = {
    enable = true;
    settings = {
      positionX = "right";
    ...
    style =
        ...
        :root {
          ...
          --noti-bg: 32, 37, 53;
          --noti-bg-alpha: 0.8;
          --noti-bg-darker: rgb(32, 37, 53);
          --noti-bg-hover: rgb(28, 33, 49);
          --noti-bg-focus: rgba(32, 37, 53, 0.0);
          --noti-close-bg: rgb(153, 193, 242);
          --noti-close-bg-hover: rgb(113, 153, 222);
        ...
        /* Fallback for older CSS themes */
        @define-color cc-bg rgba(32, 37, 53, 1.0);
        @define-color noti-border-color rgba(255, 255, 255, 0.15);
        @define-color noti-bg rgba(32, 37, 53, 1.0);
