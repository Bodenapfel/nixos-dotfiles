  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        gaps_out = 10;
        border_size = 3;
        "col.active_border" = "rgb(7EBAE4) rgb(5277C3) 45deg";
      ...
      bind = [
        ...
        "$mainMod, I, exec, $terminal nvim /home/dk/.dotfiles"
        ...
        ", F23, exec, ddcutil --bus=12 --sleep-multiplier=0.1 setvcp 10 - 10"
      ...
      bindel = [
        ...
        ",XF86MonBrightnessDown, exec, brightnessctl -e4 -n2 set 5%-s"
      ];
      bindl = [
